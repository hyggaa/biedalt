...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $to      = "khuyg0712@gmail.com"; // 🌟 Таны и-мэйл хаяг
  ...
  <main>
    <section class="contact">
      ...
      <ul class="contact-info">
        <li><i class="fas fa-phone-alt"></i> <span>+976 9622-2191</span></li>
        <li><i class="fas fa-envelope"></i> <span>khuyg0712@gmail.com</span></li>
      </ul>
      ...
      <div class="contact-icons">
        ...
        <a href="https://www.facebook.com/yukhga0712" target="_blank" title="Facebook" class="icon facebook">
          <i class="fab fa-facebook-f"></i>
        </a>
        <a href="https://www.instagram.com/yukhga/" target="_blank" title="Instagram" class="icon instagram">
